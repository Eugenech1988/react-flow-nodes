...
export const AutoLayoutButton = () => {
  ...
  return (
    <button
      ...
      className="absolute top-4 left-32.5 z-10 flex items-center justify-center h-8.5 w-9 cursor-pointer select-none transition-all duration-200 bg-[var(--card)] border border-[var(--border)] text-[var(--card-foreground)] rounded-[var(--radius)] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)] hover:bg-[var(--accent)] hover:text-[var(--accent-foreground)]"
    >
