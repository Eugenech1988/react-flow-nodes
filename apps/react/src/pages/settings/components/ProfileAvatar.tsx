  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="absolute inset-0 flex items-center justify-center bg-teal-950/50 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-200">
